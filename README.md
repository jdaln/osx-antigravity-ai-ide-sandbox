...
### Persist your real config (useful for login / OAuth)
...
If you don’t give a directory, Antigravity will still run, but it won’t be able to read/write that part of your filesystem.
